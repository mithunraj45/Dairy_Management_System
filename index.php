<?php 
  ...
  $statement = $con->prepare("SELECT * FROM tbl_website_setting");
  $statement->execute();
  $result = $statement->fetchAll(PDO::FETCH_ASSOC);
  foreach ( $result as $row) {
    $slider = $row['tbl_slider'];
    $about_us = $row['tbl_about_us'];
    $service = $row['tbl_service'];
    $features = $row['tbl_features'];
    $comments = $row['tbl_comments'];
    $blog = $row['tbl_blogs'];
}
...
?>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                            <div class="text-start p-5" style="max-width: 900px;">
                                ...
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3" style="background-color:rgb(48,60,84);border-color:rgb(48,60,84);">Explore</a>
    ...
    <!-- Banner Start -->
        <div class="container-fluid banner mb-5">
            <div class="container">
                <div class="row gx-0">
                    <div class="col-md-6">
                        <div class="bg-vegetable d-flex flex-column justify-content-center p-5" style="height: 300px;background-color:rgb(48,60,84);">
            ...
            <div class="container">
                <div class="row gx-5">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="d-flex h-90 border border-5 pt-4">
                            <img class="img-fluid mt-auto mx-auto" src="img/9.jpg">
                        </div>
                    </div>
                    <div class="col-lg-6 pb-5">
                        <div class="mb-3 pb-2">
                            <h6 class="text-primary text-uppercase">About Us</h6>
                            <h1 class="display-5">We Produce Organic Products For Your Family</h1>
                        </div>
    ...
    <!-- Facts Start -->
        <div class="container-fluid facts py-5 mb-5" style="background-color:rgb(48,60,84);">
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="mb-3">
                            <h6 class="text-uppercase" style="color:rgb(48,60,84);">Services</h6>
                        ...
                        <a href="contact.php" class="btn py-md-3 px-md-5 text-white" style="background-color:rgb(48,60,84);">Contact Us</a>
                    </div>
                    <div class="col-lg-4 col-md-6">
    ...
    <?php if($features==1){?>
    <!-- Features Start -->
        <div class="container-fluid feature py-5 pb-lg-0 my-5" style="background-color:rgb(48,60,84);">
    ...
    <?php if($comments==1){?>
    <!-- Testimonial Start -->
        <div class="container-fluid  py-5 my-5" style="background:url(img/7.jpg)">
            <div class="container py-5">
                <div class="row justify-content-center">
                    <div class="col-lg-7" >
                        <div class="owl-carousel testimonial-carousel p-5"  style="background-color:rgb(48,60,84);">
                ...
                <div class="row g-5">
                        ...
                        <div class="row g-0">
                            <div class="col-10">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="img/emp-9.jpg" alt="">
                                    <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4"  style="background-color:rgb(48,60,84);">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="row g-0">
                            <div class="col-10">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="img/emp-10.jpg" alt="">
                                    <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4"  style="background-color:rgb(48,60,84);">
                                        <h4 class="text-white">Farmer Name</h4>
                                        <span class="text-white">Designation</span>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="row g-0">
                            <div class="col-10">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="img/emp-14.jpg" alt="">
                                    <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4"  style="background-color:rgb(48,60,84);">
                                        <h4 class="text-white">Farmer Name</h4>
                                        <span class="text-white">Designation</span>
                                    </div>
