<?php require_once("header.php");?>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary py-5 mb-5" style="background:url(img/8.jpg);">
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="d-flex h-70 border border-5 border-primary pt-4">
                        <img class="img-fluid mt-auto mx-auto" src="img/emp-2.jpg">
                    </div>
                </div>
